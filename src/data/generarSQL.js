...
const inputPath = path.join(__dirname, '../data/preguntasTema3OrdenMinisterial32011_con_tema.json');
...
fs.writeFileSync(path.join(__dirname, '../data/insert_preguntasT3.sql'), sql, 'utf8');
